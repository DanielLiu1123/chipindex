...
import { getSessionForEdit, getPlayersByRecentParticipation } from '@/lib/queries'
...
export default async function EditSessionPage({ params }: { params: Promise<{ groupId: string; id: string }> }) {
  ...
  return <EditSessionForm groupId={groupId} sessionId={id} session={session} initialPlayers={players} />
}
